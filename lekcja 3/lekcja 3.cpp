// lekcja 3.cpp : Defines the entry point for the console application.
//
...
void GenerateDisplayLists()
{
	...
	glTexImage1D(GL_TEXTURE_1D, 0, GL_RGB, 8192, 0, GL_RGB, GL_UNSIGNED_BYTE, texture);
	...
	// definiowanie tekstury
	glTexImage1D(GL_TEXTURE_1D, 0, GL_LUMINANCE, 4096, 0, GL_LUMINANCE, GL_UNSIGNED_BYTE, texture);
	...
	// definiowanie tekstury
	glTexImage1D(GL_TEXTURE_1D, 0, GL_INTENSITY, 2048, 0, GL_RGB, GL_UNSIGNED_BYTE, texture);
